...
{
    /// <inheritdoc />
    public partial class InitialCreate_FromExistingDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlayerSessions_Acts_ActId",
                        column: x => x.ActId,
                        principalTable: "Acts",
                        principalColumn: "ActId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayerSessionSessionId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChoiceHistories_PlayerSessions_PlayerSessionSessionId",
                        column: x => x.PlayerSessionSessionId,
                        principalTable: "PlayerSessions",
                        principalColumn: "SessionId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChoiceHistories_PlayerSessionSessionId",
                table: "ChoiceHistories",
                column: "PlayerSessionSessionId");
