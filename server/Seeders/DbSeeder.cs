                ...
                Acts = new List<Act>
                {
                    ...
                    new Act
                    {
                        ...
                        Choices = new List<Choice>
                        {
                            ...
                            new Choice { Text = "It could be dangerous to surprise it, try speaking to get it’s attention.", NextActNumber = 112 },
...
You freeze, the air thick with tension.",
                    ...
                    new Act
                    {
                        ...
                        Choices = new List<Choice>{} // BAD END
                    },
                    new Act
                    {
                        ActNumber = 121,
                    ...
                    new Act
                    {
                        ...
                        Choices = new List<Choice>{} // UNSATISFYING END
                    },
                    new Act
                    {
                        ActNumber = 131,
                    ...
                    new Act
                    {
                        ...
                        When you reach the clearing, the dragon is still there — breathing weakly, eyes closed. Williams eyes first widen in surprise, and then narrows in focus as he quickly and quietly draws his bow and looses a single arrow. It flies straight and true, piercing the creatures skull.
                        Silence follows, broken only by the soft rattle of the creature’s final breath leaving its body.
                        When you both go to inspect the beast up close, you discover a large gash from it’s neck down its side. It was already dying.",
                        Choices = new List<Choice>{} // SAD END
                    },
                    new Act
                    {
                        ActNumber = 1321,
                        ...
                        Choices = new List<Choice>{} // WORST END
                    },
                    new Act
                    {
                        ActNumber = 11111,
                    ...
                    new Act
                    {
                        ...
                        The town healer — a wiry man with kind eyes and an impressiveard beard reaching down to his tummy — peers up as you stumble in. 
                    ...
                    new Act
                    {
                        ...
                        Choices = new List<Choice>{} // GOOD END
                    },
                    new Act
                    {
                        ActNumber = 1111221,
                        ...
                        At first he scoffs at your story, but agrees to let you lead him into the woods, if only to walk off some pent up frustration.
                        When you arrive, the dragon lies still, breathing shallowly. Williams eyes first widen in surprise, then narrows in focus. 
                    ...
                    new Act
                    {
                        ...
                        Choices = new List<Choice>{} // BEST END
                    },
                    new Act
                    {
                        ActNumber = 1111232,
